...
void antagonist::utils::configs::save(const char *name)
{
    json config;
    ...
    saveFile(appdata_path() + "\\antagonist\\" + "\\configs\\" + static_cast<std::string>(name) + ".cfg", config.dump());
}

void antagonist::utils::configs::load(const char *name)
{
    std::string configJson = "";
    loadFile(appdata_path() + "\\antagonist\\" + "\\configs\\" + static_cast<std::string>(name) + ".cfg", configJson);
